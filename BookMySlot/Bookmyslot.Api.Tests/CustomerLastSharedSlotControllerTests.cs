...
namespace Bookmyslot.Api.Tests
{
    ...
    public class CustomerLastSharedSlotControllerTests
    {
        ...
        {
            Result<CustomerLastSharedSlotModel> customerLastBookedSlotBusinessMockResponse = new Result<CustomerLastSharedSlotModel>() { ResultType = ResultType.Empty };
        ...
        {
            Result<CustomerLastSharedSlotModel> customerLastBookedSlotBusinessMockResponse = new Result<CustomerLastSharedSlotModel>() { Value = DefaultCustomerLastSharedSlotModel() };
            customerLastSharedSlotBusinessMock.Setup(a => a.GetCustomerLatestSharedSlot(It.IsAny<string>())).Returns(Task.FromResult(customerLastBookedSlotBusinessMockResponse));
