...
namespace Bookmyslot.Api.Tests
{
    ...
    public class SearchCustomerControllerTests
    {
        ...
        public async Task SearchCustomer_InValidSearchKey_ReturnsValidationResponse(string searchKey)
        {
            ...
            distributedInMemoryCacheBuisnessMock.Verify((m => m.GetFromCacheAsync(It.IsAny<CacheKeyExpiry>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())), Times.Never());
        }
        ...
        {
            Result<List<SearchCustomerModel>> distributedInMemoryCacheBuisnessMockResponse = new Result<List<SearchCustomerModel>>() { ResultType = ResultType.Empty };
            distributedInMemoryCacheBuisnessMock.Setup(a => a.GetFromCacheAsync(It.IsAny<CacheKeyExpiry>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())).Returns(Task.FromResult(distributedInMemoryCacheBuisnessMockResponse));
            ...
            distributedInMemoryCacheBuisnessMock.Verify((m => m.GetFromCacheAsync(It.IsAny<CacheKeyExpiry>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())), Times.Once());
        }

        [Test]
        public async Task SearchCustomer_ValidSearchKeyHasRecords_ReturnsSuccessResponse()
        {
            Result<List<SearchCustomerModel>> distributedInMemoryCacheBuisnessMockResponse = new Result<List<SearchCustomerModel>>() { ResultType = ResultType.Success };
            distributedInMemoryCacheBuisnessMock.Setup(a => a.GetFromCacheAsync(It.IsAny<CacheKeyExpiry>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())).Returns(Task.FromResult(distributedInMemoryCacheBuisnessMockResponse));
