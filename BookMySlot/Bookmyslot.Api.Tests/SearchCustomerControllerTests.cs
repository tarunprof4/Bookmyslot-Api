...
namespace Bookmyslot.Api.Tests
{
    ...
    public class SearchCustomerControllerTests
    {
        ...
        public async Task SearchCustomer_InValidSearchKey_ReturnsValidationResponse(string searchKey)
        {
            ...
            distributedInMemoryCacheBuisnessMock.Verify((m => m.GetFromCacheAsync(It.IsAny<CacheModel>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())), Times.Never());
        }
        ...
        public async Task SearchCustomer_ValidSearchKeyHasNoRecords_ReturnsEmptyResponse()
        {
            ...
            distributedInMemoryCacheBuisnessMock.Setup(a => a.GetFromCacheAsync(It.IsAny<CacheModel>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())).Returns(Task.FromResult(distributedInMemoryCacheBuisnessMockResponse));
            ...
            distributedInMemoryCacheBuisnessMock.Verify((m => m.GetFromCacheAsync(It.IsAny<CacheModel>(), It.IsAny<Func<Task<Result<List<SearchCustomerModel>>>>>(), It.IsAny<bool>())), Times.Once());
        }
