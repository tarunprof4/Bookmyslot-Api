...
namespace Bookmyslot.Api.Customers.Business.EventHandlers
{
    ...
    public class CustomerRegisteredNotificationHandler1 : INotificationHandler<CustomerRegisteredDomainEvent>
    {
        ...
        public CustomerRegisteredNotificationHandler1(IEventGridService eventGridService, ILoggerService loggerService)
        {
        ...
        {
            this.loggerService.Debug("CustomerRegisteredNotificationHandler1 started");
            await this.eventGridService.PublishEventAsync(EventConstants.CustomerRegisteredEvent, domainEvent);
            this.loggerService.Debug("CustomerRegisteredNotificationHandler1 ended");
        }
    }
}
